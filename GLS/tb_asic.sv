...
module tb_asic;
	...
	parameter string OUT_FILE = "GLS_with_chanis_rtl_output_POST_LPF_L_5.txt";
	...
	logic scan_en;
	logic scan_in1, scan_in2, scan_in3;
	wire scan_out1, scan_out2, scan_out3;
